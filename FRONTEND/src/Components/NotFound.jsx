...
import notFound from "../assets/Animation - 1703590527803.json";
...
const NotFound = () => {
  ...
  useEffect(() => {
    const animation = lottie.loadAnimation({
      ...
      animationData: notFound, // Your animation JSON data
  ...
  return (
    <div className=" mx-auto sm:w-[30rem] w-[20rem] mt-20">
      <div className="text-center ">
        ...
        <h1 className="font-bold text-3xl m-3 cursor-pointer">
          Page not found
          <span
