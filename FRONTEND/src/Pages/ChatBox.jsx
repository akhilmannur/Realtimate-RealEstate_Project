            ...
            <div className="flex  rounded shadow-lg h-full">
              ...
              <div className="w-1/3  flex flex-col">
                <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
                  ...
                  <div className="flex">{/* Icons or buttons */}</div>
                </div>

                {/* Search */}
                <div className="py-2 px-2 bg-grey-lighter">
                  <input
                    type="text"
              ...
              <div className="w-2/3 border flex flex-col">
                ...
                <div className="bg-grey-lighter px-4 py-4 flex items-center">
                  <div>{/* Attach file icon or button */}</div>
                  ...
                  <div>  <PaperAirplaneIcon className="h-6 w-6 text-black" /></div>
                </div>
              </div>
            </div>
          </div>
